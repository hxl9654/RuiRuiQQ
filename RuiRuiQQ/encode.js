...
var _ua = "Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1667.0 Safari/537.36";
var isMobile = _ua.indexOf("Android") > -1 || _ua.indexOf("iPhone") > -1 || _ua.indexOf("iPad") > -1 || _ua.indexOf("iPod") > -1;
var canLogin = true;
var g_appid = "501004106";
var pt = {
    uin: 0, salt: "", ckNum: {}, action: [0, 0], submitN: {}, err_m: null, isHttps: false, isIpad: false, mibao_css: "", needAt: "", t_appid: 46000101, seller_id: 703010802, needCodeTip: false, regmaster: 0, qrlogin_step: 0, qrlogin_clock: 0, qrlogin_timeout: 0, qrlogin_timeout_time: 120000, isQrLogin: false, qr_uin: "", qr_nick: "", dftImg: "http://imgcache.qq.com/ptlogin/face/1.png", js_type: 0, pt_verifysession: "", cntCheckTimeout: 0, nlog: function (e, b) {
        ...
        var b = _ua.toLowerCase();
        pt.isIpad = /ipad/i.test(b);
        pt.needCodeTip =  false;
        var c =  "";
...
(function (r) {
    ...
    function  btoa(D){if(arguments.length!=1){throw"SyntaxError: Not enough arguments"}var A=d.PADCHAR;var F=d.ALPHA;var E=d.getbyte;var C,G;var z=[];D=""+D;var B=D.length-D.length%3;if(D.length==0){return D}for(C=0;C<B;C+=3){G=(E(D,C)<<16)|(E(D,C+1)<<8)|E(D,C+2);z.push(F.charAt(G>>18));z.push(F.charAt((G>>12)&63));z.push(F.charAt((G>>6)&63));z.push(F.charAt(G&63))}switch(D.length-B){case 1:G=E(D,C)<<16;z.push(F.charAt(G>>18)+F.charAt((G>>12)&63)+A+A);break;case 2:G=(E(D,C)<<16)|(E(D,C+1)<<8);z.push(F.charAt(G>>18)+F.charAt((G>>12)&63)+F.charAt((G>>6)&63)+A);break}return z.join("")};
    r.TEA = {
...
function getEncryption(password, salt, vcode, isMd5) {
    return $.Encryption.getEncryption(password, salt, vcode, isMd5);
}